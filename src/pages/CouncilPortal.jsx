  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        venuePermissionApplicable: Boolean(formData.venuePermissionApplicable),
        ...
        prizeMoneyApplicable: Boolean(formData.prizeMoneyApplicable),
        prizeMoneyAmount: formData.prizeMoneyApplicable && formData.prizeMoneyAmount ? Number(formData.prizeMoneyAmount) : null,
        registrationFeeApplicable: Boolean(formData.registrationFeeApplicable),
        registrationFeeAmount: formData.registrationFeeApplicable && formData.registrationFeeAmount ? Number(formData.registrationFeeAmount) : null,
        attendanceWaiverApplicable: Boolean(formData.attendanceWaiverApplicable),
